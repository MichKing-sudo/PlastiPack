...
> Sistema de gestión de producción para **Plastipack S.A.** — fabricante de productos plásticos (bolsas, rollos y láminas).  
> Controla el ciclo completo desde la creación de pedidos hasta la producción y entrega.
...
│   ├── 🖥️ server.js          # Servidor Express + rutas API
...
| **Jefe de Producción** | 👷‍♂️ | Gestiona referencias, órdenes de producción y reportes |
...
npm run dev           # ▶️ Inicia servidor en :3000
```
...
cd frontend
npm install
npm run dev           # ▶️ Inicia dev server en :5173
```
...
| Rol | Usuarios |
|-----|----------|
| 👷‍♂️ **Jefe de Producción** | `jperez@plastipack.com`, `mrodriguez@plastipack.com` |
